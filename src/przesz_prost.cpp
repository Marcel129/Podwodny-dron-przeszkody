...
{
    Wektor3D powiekszony_prostopadloscian(szerokosc + 2 * promien, dlugosc + 2 * promien, wysokosc + 2 * promien);
    Wektor3D polowa_pow_prost = powiekszony_prostopadloscian*0.5;
